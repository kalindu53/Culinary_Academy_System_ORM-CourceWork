...
public class Student_form {
    ...
    void delete_onAction(ActionEvent event) {
        ...
        boolean isDeleted = studentBO.delete(new StudentDto(txt_student_D.getText(),txt_student_First_name.getText(),txt_student_last_name.getText(),txt_student_Contact.getText(),txt_student_Email.getText(),selectedCoordinator));
        if (isDeleted){
...
private boolean isValid() {
    if (!Regex.setTextColor(lk.ijse.util.TextField.ID, txt_student_D)) return false;
    if(!Regex.setTextColor(lk.ijse.util.TextField.NAME, txt_student_First_name)) return false;
    if(!Regex.setTextColor(lk.ijse.util.TextField.TEL,txt_student_Contact)) return false;
//    if (!Regex.setTextColor(lk.ijse.Easy_BookShop.Util.TextField.ADDRESS, t)) return false;
    return true;
}
    ...
    public void nameKeyReleased(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.util.TextField.NAME, txt_student_First_name);
    }
